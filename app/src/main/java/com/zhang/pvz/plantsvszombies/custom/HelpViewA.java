...
public class HelpViewA 		extends 		SurfaceView 
								implements 	SurfaceHolder.Callback
{
	...
	public HelpViewA(MainActivity activity)
	{
		super(activity);
	...
	{
		helpImage_ = activity_.otherFactory_.getImage(MainActivity.OtherFactory.Background_MainMenu_Help_1);
	}
	...
	public boolean onTouchEvent(MotionEvent event)
	{
		if (event.getAction() == MotionEvent.ACTION_DOWN) 
		{
			...
			activity_.myHandler_.sendEmptyMessage(MainActivity.Message_MainMenu_Help_2);
		}
...
///////////////////////////////////////////////////////////////////////////////
	class RefreshThread extends Thread 
	{
		...
		public RefreshThread(SurfaceHolder surfaceHolder, HelpViewA helpView)
		{
