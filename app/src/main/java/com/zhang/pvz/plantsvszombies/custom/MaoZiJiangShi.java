...
public class MaoZiJiangShi extends Zombie{
	   ...
	   DoublePlayerModeAView					doublePlayerModeAView_	= null;
		...
		//final int									frameNormalAmount_		= 22;
		...
		//final int									frameAttackAmount_		= 21;
		...
		public MaoZiJiangShi (int x, int y, DoublePlayerModeAView activity)
		{
			super(x, y,activity);
		...
		{
			frameNormalImage_				= activity_.zombieImageFactory_.getImage(MainActivity.ZombieImageFactory.Zombie_LuZhangJiangShi);
			...
			frameAttackImage_				= activity_.zombieImageFactory_.getImage(MainActivity.ZombieImageFactory.Zombie_LuZhangJiangShi_Attack);
